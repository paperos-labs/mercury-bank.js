...
Mercury.FORMATION_DOCUMENT_OPTIONS = [
...
/**
 * @typedef {"LocalBusiness"|"ForeignWithLocalOperations"|"ForeignWithoutLocalOperations"} OperationOption
 */
 ...
 * @prop {String} companyStructure
 * @prop {String} federalEin
 * @prop {String} formationDocumentType
 ...
 * @prop {String} citizenshipStatus
 * @prop {String} identificationType
 * @prop {String} address1
 * @prop {String} city
 * @prop {String} state
 * @prop {String} country
...
Mercury.create = function ({
   ...
   */
  mercury.submit = async function (_application) {
