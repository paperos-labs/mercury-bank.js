...
/**
 * These can be seen in the UI:
 *   - Articles of Incorporation
 *   - Articles of Organization
 *   - Partnership Agreement
 *   - Certificate of Formation
 *   - Secretary of State Registration Page
 * And these are what are documented for the API, but not all of them work:
 ...
 * So these are the ones we support
 * @typedef {"ArticlesOfIncorporation"|"ArticlesOfOrganization"|"PartnershipAgreement"|"CertificateOfFormation"|"SecretaryOfStateRegistrationPage"} FormationDocumentTypeOption
 */
Mercury.FORMATION_DOCUMENT_TYPE_OPTIONS = [
  "ArticlesOfIncorporation",
  "ArticlesOfOrganization",
  "PartnershipAgreement", // on web form
  //"AssumedNameCertificate", // not on web form
  //"CertificateOfGoodStanding",
  //"OtherBusinessDocumentation",
  //"TrustAgreement",
  "CertificateOfFormation",
  "SecretaryOfStateRegistrationPage", // on web form
];
